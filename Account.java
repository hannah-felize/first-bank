...
public class Account {
    ...
    void withdraw(int amount) {
        if (amount != 0) {
            balance = balance - amount;
            previousTransaction = -amount; // previous transaction is negative amount
        }
    }
    ...
    void showMenu() {
        char option = '\0';
        Scanner scanner = new Scanner(System.in); // create a scanner object since you're taking in user input
